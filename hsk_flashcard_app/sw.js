...
const CACHE='hsk-flashcards-v41';
const ASSETS=[
  ...
  'core/sessions/study-session-state-machine.js',
  ...
  'packs/catalog.js','core/content/pack-registry.js',
  'core/content/pack-boot.js','core/content/pack-boot-shim.js',
